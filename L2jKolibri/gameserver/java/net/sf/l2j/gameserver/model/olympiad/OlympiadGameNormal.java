...
abstract public class OlympiadGameNormal extends AbstractOlympiadGame {
	...
	protected void validateWinner(OlympiadStadiumZone stadium) {
		...
		final int pointDiff = MathUtil.limit(Math.min(playerOnePoints, playerTwoPoints) / getDivider(), 1,
				Config.OLY_MAX_POINTS);
	...
	protected static final void saveResults(Participant one, Participant two, int winner, long startTime,
			long fightTime, OlympiadType type) {
