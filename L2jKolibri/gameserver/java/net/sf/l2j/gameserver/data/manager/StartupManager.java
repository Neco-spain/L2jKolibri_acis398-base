...
//import net.sf.l2j.gameserver.model.actor.Experience;
...
//				public void run() {
//					player.sendPacket(
//							new ExShowScreenMessage("Complete your character and get ready for our world!", 10000));
...
//		} else if (classes == ClassId.TREASURE_HUNTER || classes == ClassId.HAWKEYE || classes == ClassId.PLAINS_WALKER
//				|| classes == ClassId.SILVER_RANGER || classes == ClassId.ABYSS_WALKER
//				|| classes == ClassId.PHANTOM_RANGER) {
//			NpcHtmlMessage html = new NpcHtmlMessage(1);
...
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Necromancer!", 4000));
//			break;
//		case "sorceror":
//			player.setClassId(12);
//			player.setBaseClass(12);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Sorceror!", 4000));
//			break;
//		case "warlock":
//			player.setClassId(14);
//			player.setBaseClass(14);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Warlock!", 4000));
//			break;
//		case "cleric":
//			player.setClassId(15);
//			player.setBaseClass(15);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Cleric!", 4000));
//			break;
//		case "bishop":
//			player.setClassId(16);
//			player.setBaseClass(16);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Bishop!", 4000));
//			break;
//		case "prophet":
//			player.setClassId(17);
//			player.setBaseClass(17);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Prophet!", 4000));
//			break;
//		case "spellsinger":
//			player.setClassId(27);
//			player.setBaseClass(27);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Spellsinger!", 4000));
//			break;
//		case "elemental":
//			player.setClassId(28);
//			player.setBaseClass(28);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Elemental Summoner!", 4000));
//			break;
//		case "elder":
//			player.setClassId(30);
//			player.setBaseClass(30);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Elven Elder!", 4000));
//			break;
//		case "spellhowler":
//			player.setClassId(40);
//			player.setBaseClass(40);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Spellhowler!", 4000));
//			break;
//		case "shilliene":
//			player.setClassId(43);
//			player.setBaseClass(43);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Shillien Elder!", 4000));
//			break;
//		case "overlord":
//			player.setClassId(51);
//			player.setBaseClass(51);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Overlord!", 4000));
//			break;
//		case "warcryer":
//			player.setClassId(52);
//			player.setBaseClass(52);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Warcryer!", 4000));
//			break;
//		}
//		player.addExpAndSp(PlayerLevelData.getInstance().getPlayerLevel(Config.NEWBIE_LVL], 0);
...
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Gladiator!", 4000));
//			break;
//		case "warlord":
//			player.setClassId(3);
//			player.setBaseClass(3);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Warlord!", 4000));
//			break;
//		case "paladin":
//			player.setClassId(5);
//			player.setBaseClass(5);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Paladin!", 4000));
//			break;
//		case "darkavenger":
//			player.setClassId(6);
//			player.setBaseClass(6);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Dark Avenger!", 4000));
//			break;
//		case "temple":
//			player.setClassId(20);
//			player.setBaseClass(20);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Temple Knight!", 4000));
//			break;
//		case "swordsinger":
//			player.setClassId(21);
//			player.setBaseClass(21);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Swordsinger!", 4000));
//			break;
//		case "shillien":
//			player.setClassId(33);
//			player.setBaseClass(33);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Shillien Knight!", 4000));
//			break;
//		case "bladedancer":
//			player.setClassId(34);
//			player.setBaseClass(34);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Bladedancer!", 4000));
//			break;
//		case "phantoms":
//			player.setClassId(41);
//			player.setBaseClass(41);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Phantom Summoner!", 4000));
//			break;
//		case "destroyer":
//			player.setClassId(46);
//			player.setBaseClass(46);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Destroyer!", 4000));
//			break;
//		case "tyrant":
//			player.setClassId(48);
//			player.setBaseClass(48);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Tyrant!", 4000));
//			break;
//		case "bounty":
//			player.setClassId(55);
//			player.setBaseClass(55);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Bounty Hunter!", 4000));
//			break;
//		case "warsmith":
//			player.setClassId(57);
//			player.setBaseClass(57);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Warsmith!", 4000));
//			break;
//		}
...
//		doEquip(player, 90);
//		NpcHtmlMessage html = new NpcHtmlMessage(1);
//		if (classes == ClassId.TREASURE_HUNTER || classes == ClassId.HAWKEYE || classes == ClassId.PLAINS_WALKER
//				|| classes == ClassId.SILVER_RANGER || classes == ClassId.ABYSS_WALKER
//				|| classes == ClassId.PHANTOM_RANGER)
//			html.setFile("data/html/mods/startup/armors/lightarmors.htm");
//		html.setFile("data/html/mods/startup/armors/fighterarmors.htm");
...
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Treasure Hunter!", 4000));
//			break;
//		case "hawkeye":
//			player.setClassId(9);
//			player.setBaseClass(9);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Hawkeye!", 4000));
//			break;
//		case "plain":
//			player.setClassId(23);
//			player.setBaseClass(23);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Plainswalker!", 4000));
//			break;
//		case "silver":
//			player.setClassId(24);
//			player.setBaseClass(24);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Silver Ranger!", 4000));
//			break;
//		case "abyss":
//			player.setClassId(36);
//			player.setBaseClass(36);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Abyss Walker!", 4000));
//			break;
//		case "phantom":
//			player.setClassId(37);
//			player.setBaseClass(37);
//			player.sendPacket(new ExShowScreenMessage("Your class has changed to Phantom Ranger!", 4000));
//			break;
//		}
//		player.addExpAndSp(Experience.LEVEL[Config.NEWBIE_LVL], 0);
//		player.broadcastPacket(new SocialAction(player, 3));
...
//		for (int id : (player.isMageClass() || player.getClassId() == ClassId.DOMINATOR
//				|| player.getClassId() == ClassId.DOOMCRYER) ? Config.NEWBIE_MAGE_BUFFS : Config.NEWBIE_FIGHTER_BUFFS) {
...
//			@Override
//			public void run() {
//				player.sendPacket(new CreatureSay(0, SayType.PARTY, "[SYSTEM]", " WELCOME TO OUR SERVER!"));
