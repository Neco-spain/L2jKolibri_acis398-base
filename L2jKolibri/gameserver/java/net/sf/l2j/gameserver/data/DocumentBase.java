	...
	protected void attachEffect(Node n, Object template, Condition attachCond) {
		...
		if (attrs.getNamedItem("activationChance") != null)
			activationChance = Integer
					.parseInt(getValue(attrs.getNamedItem("activationChance").getNodeValue(), template));
		...
		lt = new EffectTemplate(attachCond, name, value, count, time, abnormal, stackType, stackOrder, icon,
				effectPower, type, trigId, trigLvl, chance);
