...
public final class Say2 extends L2GameClientPacket {
	...
	private static final String[] WALKER_COMMAND_LIST = { "USESKILL", "USEITEM", "BUYITEM", "SELLITEM", "SAVEITEM",
			"LOADITEM", "MSG", "DELAY", "LABEL", "JMP", "CALL", "RETURN", "MOVETO", "NPCSEL", "NPCDLG", "DLGSEL",
			"CHARSTATUS", "POSOUTRANGE", "POSINRANGE", "GOHOME", "SAY", "EXIT", "PAUSE", "STRINDLG", "STRNOTINDLG",
			"CHANGEWAITTYPE", "FORCEATTACK", "ISMEMBER", "REQUESTJOINPARTY", "REQUESTOUTPARTY", "QUITPARTY",
			"MEMBERSTATUS", "CHARBUFFS", "ITEMCOUNT", "FOLLOWTELEPORT" };
	...
	protected void runImpl() {
		...
		if (Config.LOG_CHAT) {
			...
			if (type == SayType.TELL)
				record.setParameters(new Object[] { type, "[" + player.getName() + " to " + _target + "]" });
			else
				record.setParameters(new Object[] { type, "[" + player.getName() + "]" });
