...
import net.sf.l2j.gameserver.model.holder.SkillBalanceHolder;
 ...
 */
public class SkillBalanceManager extends XMLDocument
{
	...
	protected void load()
	{
		loadDocument("./data/xml/balancer/skillbalance/SkillBalance.xml");
