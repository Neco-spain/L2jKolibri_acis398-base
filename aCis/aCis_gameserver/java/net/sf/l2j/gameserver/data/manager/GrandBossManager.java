...
public class GrandBossManager {
	...
	public void setBossStatus(int bossId, int status) {
		...
		LOGGER.info("Updated {} (id: {}) status to {}.", NpcData.getInstance().getTemplate(bossId).getName(), bossId,
				status);
	...
	/**
	 * Add a {@link GrandBoss} to the list of bosses. Using this variant of addBoss,
	 * we can impose a npcId.
	 * 
	...
	/**
	 * Saves all {@link GrandBoss}es info and then clears all info from memory,
