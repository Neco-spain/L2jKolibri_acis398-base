...
public class Olympiad {
	 ...
	 * @return The old {@link StatSet} if the {@link Player} objectId was already
	...
	public static void olympiadEnd(Player player) {
		...
		CreatureSay cs = new CreatureSay(0, SayType.PARTY, "[System]",
	...
	/**
	 * Add Config.OLY_WEEKLY_POINTS to registered {@link Player} every
	 * Config.OLY_WPERIOD.
	 */
	...
	private void olympiadEnd() {
		World.toAllOnlinePlayers(
				SystemMessage.getSystemMessage(SystemMessageId.OLYMPIAD_PERIOD_S1_HAS_ENDED).addNumber(_currentCycle));
