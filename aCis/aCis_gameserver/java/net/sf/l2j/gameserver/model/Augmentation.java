 ...
 * <br>
 * Weapon Augmentation, alongside with enchanting and special abilities, adds
 * special, random, features.<br>
 * <br>
 * Augmented items cannot be sold or transferred, they cannot be lost if your
 * character dies, they cannot be dropped, however you can store them in your
 * warehouse.
 */
public final class Augmentation {
	...
	/**
	 * Applies this {@link Augmentation} boni to the {@link Player} set as
	 * parameter.
	 * 
	...
	/**
	 * Removes this {@link Augmentation} boni to the {@link Player} set as
	 * parameter.
	 * 
	 * @param player : The Augmentation boni benefactor.
	 */
