...
public class BossSpawn {
	...
	public String toString() {
		return "BossSpawn{" + "npcId=" + _spawn.getNpcId() + ", status=" + _status + ", hp=" + _currentHp + ", mp="
				+ _currentMp + ", respawnTime=" + _respawnTime + "}";
	}
	 ...
	 * <ul>
	 * <li>Calculate the new respawn time, based on {@link Spawn} respawn
	 * delays.</li>
	 * <li>Refresh this {@link BossSpawn} holder.</li>
	 * <li>Cancel any running {@link ScheduledFuture}, and reschedule it with new
	 * respawn time.</li>
	 * <li>Save informations on database.</li>
	 * </ul>
	 */
	public void onDeath() {
		// getRespawnMinDelay() is used as fixed timer, while getRespawnMaxDelay() is
		// used as random timer.
		final int respawnDelay = _spawn.getRespawnMinDelay()
				+ Rnd.get(-_spawn.getRespawnMaxDelay(), _spawn.getRespawnMaxDelay());
	...
	/**
	 * Update the respawn time and current HP/MP of this {@link BossSpawn} on the
	 * database.
	 */
