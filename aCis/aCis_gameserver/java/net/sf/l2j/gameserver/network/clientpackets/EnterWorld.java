...
public class EnterWorld extends L2GameClientPacket {
	...
	private static void onEnterVip(Player activeChar) {
		...
		if (now > endDay) {
			...
			activeChar
					.sendPacket(new CreatureSay(0, SayType.PARTYROOM_COMMANDER, "System", "Your VIP status is over!"));
			...
			activeChar.sendPacket(
					new CreatureSay(0, SayType.PARTYROOM_COMMANDER, "System", "Your VIP status ends on: " + dt));
